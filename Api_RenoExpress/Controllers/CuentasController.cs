...
namespace Api_RenoExpress.Controllers
{
    ...
    public class CuentasController : ControllerBase
    {
        ...
        {
            var user = new ApplicationUser { UserName = model.Email, Email = model.Email, CodigoUsuario = model.CodigoUsuario, CodigoRol= model.CodigoRol, 
                Nombre=model.Nombre, Apellido=model.Apellido, Direccion=model.Direccion, Telefono=model.Telefono };
